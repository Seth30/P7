...
namespace P5
{
    public partial class FormMain : Form
    {
        ...
        private void issuesRecordToolStripMenuItem_Click(object sender, System.EventArgs e)
        {
            ...
            FormRecord form = new FormRecord(name);
            form.ShowDialog();
            form.Dispose();
        }
        ...
        {
            string name = this.Text.Substring(7);
            FormCreateRequirement form = new FormCreateRequirement(name);
            form.ShowDialog();
            form.Dispose();
        }
        ...
        {
            string name = this.Text.Substring(7);
            FormModifyRequirement form = new FormModifyRequirement(name);
            form.ShowDialog();
            form.Dispose();
        }
        ...
        {
            string name = this.Text.Substring(7);
            FormRemoveRequirement form = new FormRemoveRequirement(name);
            form.ShowDialog();
            form.Dispose();
        }
        ...
        {
            string name = this.Text.Substring(7);
            FormRemoveFeature form = new FormRemoveFeature(name);
            form.ShowDialog();
            form.Dispose();
        }
    }
